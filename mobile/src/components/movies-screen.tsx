...
// (tens of thousands of rows) that drift compounds into the FlatList
// virtualization window landing on the wrong offset, rendering nothing for
// most of the list. Relying on FlatList's own measurement (slower to jump
// far via scrollToIndex, but correct) is the tradeoff that actually works
// at this scale; see onScrollToIndexFailed below for the retry that covers
// the slower jump.
